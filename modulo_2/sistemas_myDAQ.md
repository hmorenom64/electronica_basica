...
# **CURSO DE ELECTRONICA BASICA PARA INGENIEROS. MODULO 2. SISTEMAS IMPLEMENTADOS CON MYDAQ**
...
| [Anterior](microcontrol.md)| [:house: Inicio](../readme.md) | [:beginner: Ayuda / Colabora] | [Siguiente](sistemas_MYRIO.md) |
|----------------------------|-----------------------------------|--------------------------------------------------------------------------------------------------|-----------------------------------------|
